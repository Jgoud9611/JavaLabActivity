...
import com.schoolmgnt.exception.DataNotFoundException;
import com.schoolmgnt.exception.UserNotFoundException;
...
public class TeacherController 
{
	...
	//	}
			//catch(Exception e)
		//	{
		//		throw new UserNotFoundException("Student data not inserted ! please enter the valid input");
		//	}
	...
	public ResponseEntity<Teacher> deleteTeacherDetails(@PathVariable("teacherId") int teacherId)
	{
		...
		{
			//throw new UserNotFoundException("Teacher data not Deleted ! please enter the valid input");
	 ...
	 public ResponseEntity<Teacher> updateTeacherDetails(@RequestBody Teacher teacher,@PathVariable int teacherId) 
	{
		...
		{
			throw new DataNotFoundException("Teacher data not Modified ! please enter the valid input");
		}
